        ...
        <div className="grid gap-12 lg:grid-cols-[2fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="max-w-xs text-sm leading-relaxed text-secondary">
              The loyalty network for local business. Sell live, keep more of every dollar (just 1.5% per order), and bring customers back with rewards that work at every shop on the network.
            </p>
