 ...
 *   Whatnot:    up to 8% of GMV + 2.9% of GMV + $0.30 per txn
...
const WHATNOT_COMMISSION = 0.08;   // Whatnot's top published rate (their site says ≤8%, varies by category)
      ...
      <div className="rounded-3xl border border-zinc-700/50 bg-zinc-900/60 p-6 backdrop-blur-sm sm:p-10">
        ...
        <div className="mb-8 text-center">
          ...
          <h2 className="text-2xl font-extrabold tracking-tight text-white sm:text-3xl">
            See what you&apos;d save vs Whatnot&apos;s up to 8% commission.
          </h2>
          <p className="mx-auto mt-2 max-w-lg text-sm text-zinc-400">
            Drag the slider. DUM Club: $99/mo Growth tier plus a 1.5% sales fee per order. Whatnot: up to 8% + 2.9% Stripe on every sale, using their top rate here. DUM Club also replaces loyalty, retention, and deal-platform tools, all in the same subscription.
          </p>
        </div>
