...
This allows cron agents (live_reminders, schedule_rollforward,
trial_reminders, merchant_recap) to call get_client() directly without
needing a FastAPI lifespan.
"""
import os
...
def get_client():
        """Return the shared Supabase client, initialising it lazily on first call.
